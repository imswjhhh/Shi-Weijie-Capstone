...
trans = MissingValuesFiller()
series = trans.transform(series)
# convert to float32
...
def objective(trial):
    ...
    print(num_encoder_layers, num_decoder_layers, dim_feedforward, dropout, batch_size, lr)
    ...
    model_transformer = TransformerModel.load_from_checkpoint(model_name="transformer", best=True)
